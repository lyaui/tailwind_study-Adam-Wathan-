<template>
  <div>
    <!-- padding-bottom設定用百分比，建立固定比例自適應寬度的區塊 -->
    <div class="relative rounded-lg overflow-hidden shadow-md" style="padding-bottom:80%">
      <img
        class="absolute h-full w-full object-cover"
        :src="property.imageUrl"
        :alt="property.imageAl"
      />
    </div>
    <div class="px-4 -mt-16 relative">
      <div class="bg-white p-6 rounded-lg  shadow-md">
        <div class="flex items-baseline">
          <span class="inline-block bg-teal-200 text-teal-800 text-xs  px-2 rounded-full uppercase"
            >New</span
          >
